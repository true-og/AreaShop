...
public class WorldGuardRegionFlagsFeature extends RegionFeature {
    ...
    private boolean updateRegionFlags(GeneralRegion region) {
        ...
        ConfigurationSection flagProfileSection = region.getConfigurationSectionSetting("general.flagProfile",
                "flagProfiles");
        ...
        // If in reselling mode, fallback to 'resale' section if 'resell' is not found
        // (legacy configuration problem:
        // https://github.com/NLthijs48/AreaShop/issues/303)
    ...
    private boolean updateRegionFlags(GeneralRegion region, ConfigurationSection flags) {
        ...
        for (String flagName : flagNames) {
            ...
            // In the config normal Bukkit color codes are used, those only need to be
            // translated on 5.X WorldGuard versions
            ...
            if (flagName.equalsIgnoreCase("members")) {
                ...
                // AreaShop.debug(" Flag " + flagName + " set: " +
                ...
                if (foundFlag == null) {
                    ...
                    AreaShop.warn("Found wrong flag in flagProfiles section: " + flagName
                            + ", check if that is the correct WorldGuard flag");
                    continue;
                ...
                if (value == null || value.isEmpty()) {
                            ...
                            if (part.startsWith("g:")) {
                                ...
                                if (part.length() > 2) {
                                    ...
                                    try {
                                        ...
                                        groupValue = worldGuardInterface.parseFlagGroupInput(groupFlag,
                                                part.substring(2));
                    ...
                    if (groupValue != null) {
                        ...
                        if (groupValue == groupFlag.getDefault()) {
                            ...
                            // AreaShop.debug(" Group of flag " + flagName + " set to default: " +
                            // groupValue);
                        } else {
    ...
    /**
     * Build an RegionAccessSet from an input that specifies player names, player
     * uuids and groups.
     * 
            ...
            if (access != null && !access.isEmpty()) {
                ...
                if (access.startsWith("g:")) {
                    ...
                    try {
                        ...
                        AreaShop.warn("Tried using '" + access
                                + "' as uuid for a region member/owner, is your flagProfiles section correct?");
    ...
    /**
     * Translate the color codes you put in greeting/farewell messages to the weird
     * color codes of WorldGuard.
     * 
     * @param message The message where the color codes should be translated (this
     *                message has bukkit color codes)
