...
public final class AreaShop extends JavaPlugin implements AreaShopApi {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("checkForUpdates")) {
            ...
            githubUpdateCheck = new GithubUpdateCheck(this, "md5sha256", "AreaShop")
                    .withVersionComparator((latestVersion, currentVersion) ->
                    {
                        ...
                        AreaShop.info("Update from AreaShop V" + cleanVersion(result.getCurrentVersion())
                                + " to AreaShop V" + cleanVersion(result.getLatestVersion())
                                + " available, get the latest version at https://github.com/md5sha256/AreaShop/releases");
