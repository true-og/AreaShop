...
public class AcceptedValuesParser<C> implements ArgumentParser<C, String>, SuggestionProvider<C> {
    ...
    private AcceptedValuesParser(@Nonnull Supplier<Collection<String>> valuesProvider,
            @Nonnull String failureMessageKey, boolean caseSensitive
    ...
    public static <C> AcceptedValuesParser<C> ofConstant(@Nonnull Collection<String> acceptedValues,
            @Nonnull String failureMessageKey, boolean caseSensitive)
    {
    ...
    public static <C> AcceptedValuesParser<C> of(@Nonnull Supplier<Collection<String>> supplier,
            @Nonnull String failureMessageKey, boolean caseSensitive)
    {
    ...
    public static <C> AcceptedValuesParser<C> ofCached(@Nonnull Supplier<Collection<String>> supplier,
            @Nonnull String failureMessageKey, boolean caseSensitive)
    {
            ...
            @Nonnull CommandInput input)
    {
        ...
        Iterable<Suggestion> suggestions = this.valuesProvider.get().stream().filter(s -> s.startsWith(text))
