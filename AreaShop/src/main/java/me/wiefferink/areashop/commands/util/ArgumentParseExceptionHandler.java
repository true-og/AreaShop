...
public class ArgumentParseExceptionHandler<C extends CommandSender>
        implements ExceptionHandler<C, AreaShopCommandException>
{
    ...
    public static void handleException(@Nonnull MessageBridge messageBridge, @Nonnull CommandSender sender,
