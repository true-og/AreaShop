...
public class GroupAddCommand extends AreashopCommandBean {
    ...
    @Inject
    public GroupAddCommand(@Nonnull MessageBridge messageBridge, @Nonnull IFileManager fileManager,
            ...
            @Nonnull Command.Builder<CommandSender> builder)
    {
        ...
        return builder.literal("groupadd").required(KEY_GROUP, StringParser.stringParser(), this::suggestGroupNames)
    ...
    private void handleCommand(@Nonnull CommandContext<CommandSender> context) {
        ...
        if (declaredRegion != null) {
            ...
            this.messageBridge.message(sender, "groupadd-success", group.getName(), group.getMembers().size(),
                    declaredRegion);
            return;
        ...
        if (!regionsSuccess.isEmpty()) {
            ...
            messageBridge.message(sender, "groupadd-weSuccess", group.getName(),
        ...
        if (!regionsFailed.isEmpty()) {
            ...
            messageBridge.message(sender, "groupadd-weFailed", group.getName(),
