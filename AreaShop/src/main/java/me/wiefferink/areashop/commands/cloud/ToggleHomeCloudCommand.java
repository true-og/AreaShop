...
@Singleton
public final class ToggleHomeCloudCommand extends CloudCommandBean {
    ...
    @Inject
    public ToggleHomeCloudCommand(@Nonnull MessageBridge messageBridge, @Nonnull IFileManager fileManager) {
