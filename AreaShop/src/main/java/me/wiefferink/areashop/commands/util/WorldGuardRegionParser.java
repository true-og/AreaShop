...
public class WorldGuardRegionParser<C extends Entity> implements ArgumentParser<C, ProtectedRegion> {
    ...
    public WorldGuardRegionParser(@Nonnull CommandFlag<World> worldFlag,
    ...
    public static <C extends Entity> ParserDescriptor<C, ProtectedRegion> worldGuardRegionParser(
            @Nonnull CommandFlag<World> worldFlag, @Nonnull WorldGuardInterface worldGuardInterface)
    {
            ...
            @Nonnull CommandInput commandInput)
    {
        ...
        if (regionManager == null) {
            ...
            return ArgumentParseResult
                    .failure(new IllegalArgumentException("No region manager for world: " + world.getName()));
    ...
    public @Nonnull SuggestionProvider<C> suggestionProvider() {
        ...
        return SuggestionProvider.blockingStrings((commandContext, input) -> {
            ...
            return this.worldGuardInterface.getRegionManager(player.getWorld()).getRegions().values().stream()
