...
public class GithubUpdateCheck {
    ...
    public static final String USER_AGENT = "true-og AreaShop-OG GithubUpdateCheck";
     ...
     * 
     * @param plugin     The plugin to create it for (used for logging and checking
     *                   version)
    ...
    public GithubUpdateCheck(Plugin plugin, String author, String repository) {
        ...
        this.versionComparator = (latest, current) -> !latest.equalsIgnoreCase(current);
     ...
     * 
     * @param versionComparator VersionComparator to use for checking if one version
            ...
            public void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        logger.severe("Invalid url: '" + url + "', are the author '" + author + "' and repository '"
                                + repository + "' correct?");
                        error = true;
                        return;
    ...
    public interface VersionComparator {
         ...
         * @return true if the latestVersion is newer than the localVersion, otherwise
         *         false
         */
    ...
    public String toString() {
        ...
        return "GithubUpdateCheck("
                + StringUtils.join(Arrays.asList("author=" + author, "repository=" + repository,
                        "plugin=" + plugin.getName(), "checking=" + checking, "hasUpdate=" + hasUpdate,
                        "error=" + error, "currentVersion=" + currentVersion, "latestVersion=" + latestVersion), ", ")
                + ")";
