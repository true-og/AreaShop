...
public final class SignUtils {
    ...
    /**
     * Get the {@link BlockFace} of a sign block If the passed {@link Block} is not
     * an instance of either a {@link Sign} or {@link WallSign}, this method will
    ...
    /**
     * Set the {@link BlockFace} in which the sign will face If the passed
     * {@link Block} is not an instance of either a {@link Sign} or
     * {@link WallSign}, this method will return <code>null</code>.
     *
     * @param block  The sign block
     * @param facing The new {@link BlockFace} the sign should face
     * @return Returns <code>true</code> if the sign was successfully placed,
    ...
    /**
     * Get the {@link Block} which a given sign is attached to. This method will
     * return <code>null</code> if the passed {@link Block} is not an instance of
     * either a {@link Sign} or {@link WallSign}.
     *
