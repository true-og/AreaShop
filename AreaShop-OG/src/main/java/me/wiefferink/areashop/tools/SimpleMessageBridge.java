...
public class SimpleMessageBridge implements MessageBridge {
    ...
    public static void send(Message message, CommandSender target) {
        ...
        if (message.get() == null || message.get().isEmpty()
                || (message.get().size() == 1 && message.get().get(0).isEmpty()))
        {
    ...
    public static void send(Message message, Object target) {
        ...
        if (target instanceof CommandSender sender) {
            ...
            String error = "AreaShop-OG sent a non-supported Object. %s is not a CommandSender!";
    ...
    @Override
    public void messagePersistent(@Nonnull OfflinePlayer target, @Nonnull String key, @Nonnull Object... replacements) {
    ...
    public void messagePersistent(@Nonnull OfflinePlayer target, @Nonnull Message message) {
        ...
        if (AreaShop.useMiniMessage()) {
            ...
            // The lang file we are using will already provide languages in MiniMessage
            // format
