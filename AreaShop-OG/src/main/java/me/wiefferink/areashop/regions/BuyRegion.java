...
public class BuyRegion extends GeneralRegion {
        ...
        if (isResell && oldOwner != null) {
            ...
            plugin.runEconomyTask(() -> {
                ...
                try {
                    ...
                    economy.playerPayPlayer(payingPlayer.getUniqueId(), oldOwner, resellPriceShards,
                            "AreaShop-OG resell: " + getName(), null);
                ...
                if (isDeleted() || !isInResellingMode() || !oldOwner.equals(getBuyer())) {
                    ...
                    reversePayment(payingPlayer.getUniqueId(), oldOwner, resellPriceShards,
                            "AreaShop-OG resell reversal: " + getName());
                    message(offlinePlayer, "buy-payError");
                    return;
            ...
            plugin.runEconomyTask(() -> {
                ...
                try {
                    ...
                    economy.consumeFromPlayer(payingPlayer.getUniqueId(), priceShards, "AreaShop-OG buy: " + getName(),
                            null);
                ...
                if (landlord != null) {
                    ...
                    try {
                        ...
                        economy.addToPlayerBankShards(landlord, priceShards, "AreaShop-OG buy: " + getName(), null);
                        ...
                        try {
                            ...
                            economy.addToPlayerBankShards(payingPlayer.getUniqueId(), priceShards,
                                    "AreaShop-OG buy refund: " + getName(), null);
                ...
                if (isDeleted() || isSold()) {
                    ...
                    refundShards(payingPlayer.getUniqueId(), priceShards, "AreaShop-OG buy refund: " + getName());
                    message(offlinePlayer, "buy-payError");
                    return;
    ...
    public boolean sell(boolean giveMoneyBack, CommandSender executor) {
        ...
        if (isDeleted()) {
            ...
            refundShards(payBackTo, moneyBackShards, "AreaShop-OG sell: " + getName());
            finishSell(executor, moneyBack);
            return true;
        ...
        plugin.runEconomyTask(() -> {
            ...
            try {
                ...
                economy.addToPlayerBankShards(payBackTo, moneyBackShards, "AreaShop-OG sell: " + getName(), null);
                return true;
