...
public class OwnershipControlValidator implements AccessControlValidator {
    ...
    public boolean canAccess(@Nonnull final UUID player, @Nonnull final GeneralRegion region,
    ...
    private boolean canAccessMembers(@Nonnull final UUID player, @Nonnull final GeneralRegion region) {
