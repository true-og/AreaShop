...
public final class HomeAccessFeature extends RegionFeature {
    ...
    @AssistedInject
    public HomeAccessFeature(@Assisted final GeneralRegion region, @Nonnull final AreaShop plugin) {
    ...
    private @Nonnull HomeAccessType parseAccessType() {
        ...
        String rawAccessType = getRegion().getConfig().getString("sethomecontrol.homeaccesstype",
                HomeAccessType.ANY.name());
        try {
