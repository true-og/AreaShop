...
public class DebugFeature extends RegionFeature {
    ...
    public void buyingRegion(BuyingRegionEvent event) {
        ...
        AreaShop.debug("BuyingRegionEvent: " + event.getPlayer().getName() + " is trying to buy "
    ...
    public void boughtRegion(BoughtRegionEvent event) {
        ...
        AreaShop.debug(
                "BoughtRegionEvent: " + event.getRegion().getPlayerName() + " bought " + event.getRegion().getName());
    ...
    public void sellingRegion(SellingRegionEvent event) {
        ...
        AreaShop.debug("SellingRegionEvent: " + event.getRegion().getName() + " is trying to sell "
                + event.getRegion().getName());
    ...
    public void soldRegion(SoldRegionEvent event) {
        ...
        AreaShop.debug(
                "SoldRegionEvent: " + Utils.toName(event.getOldBuyer()) + " sold " + event.getRegion().getName());
    ...
    public void resellingRegion(ResellingRegionEvent event) {
        ...
        AreaShop.debug("ResellingRegionEvent: " + event.getRegion().getName() + " is trying to resell "
                + event.getRegion().getName());
    ...
    public void resoldRegion(ResoldRegionEvent event) {
        ...
        AreaShop.debug("ResoldRegionEvent: " + Utils.toName(event.getFromPlayer()) + " resold "
                + event.getRegion().getName() + " to " + event.getRegion().getPlayerName());
    ...
    public void rentingRegion(RentingRegionEvent event) {
        ...
        AreaShop.debug("RentingRegionEvent: " + event.getPlayer().getName() + " is trying to rent "
                + event.getRegion().getName() + ", extending=" + event.isExtending());
    ...
    public void rentedRegion(RentedRegionEvent event) {
        ...
        AreaShop.debug("RentedRegionEvent: " + event.getRegion().getPlayerName() + " rented "
                + event.getRegion().getName() + ", extending=" + event.hasExtended());
    ...
    public void unrentingRegion(UnrentingRegionEvent event) {
        ...
        AreaShop.debug("UnrentingRegionEvent: " + event.getRegion().getPlayerName() + " is trying to unrent "
                + event.getRegion().getName());
    ...
    public void unrentedRegion(UnrentedRegionEvent event) {
        ...
        AreaShop.debug("UnrentedRegionEvent: " + Utils.toName(event.getOldRenter()) + " unrented "
                + event.getRegion().getName());
    ...
    public void regionUpdate(UpdateRegionEvent event) {
        ...
        // AreaShop.debug("UpdateRegionEvent: " + event.getRegion().getName() + "
        // updated");
    }
    ...
    public void addedFriend(AddedFriendEvent event) {
        ...
        AreaShop.debug("AddedFriendEvent: region " + event.getRegion().getName() + ", " + event.getFriend().getName()
                + " by " + (event.getBy() == null ? "<nobody>" : event.getBy().getName()));
    ...
    public void deleteFriend(DeletedFriendEvent event) {
        ...
        AreaShop.debug("DeletedFriendEvent: region " + event.getRegion().getName() + ", " + event.getFriend().getName()
                + " by " + (event.getBy() == null ? "<nobody>" : event.getBy().getName()));
