...
public class SetDurationCommand extends AreashopCommandBean {
    ...
    @Inject
    public SetDurationCommand(@Nonnull MessageBridge messageBridge, @Nonnull IFileManager fileManager) {
            ...
            @NotNull Command.Builder<CommandSender> builder)
    {
        ...
        return builder.literal("setduration").required(KEY_DURATION, StringParser.stringParser()).flag(this.regionFlag)
    ...
    private void handleCommand(@Nonnull CommandContext<CommandSender> context) {
        ...
        if (!sender.hasPermission("areashop.setduration")
                && (!sender.hasPermission("areashop.setduration.landlord") && sender instanceof Player))
        {
        ...
        if (!sender.hasPermission("areashop.setduration")
                && !(sender instanceof Player player && rent.isLandlord(player.getUniqueId())))
        {
