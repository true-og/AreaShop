            ...
            if (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK) {
                ...
                while (blockIterator.hasNext()) {
                    ...
                    if (regions.size() == 1) {
                        ...
                        messageBridge.message(player, "linksigns-multipleRegions",
                                Utils.createCommaSeparatedList(names));
    ...
    private class SignLinker {
        ...
        public void setSign(Location location, Material type, BlockFace facing) {
            ...
            if (!isComplete()) {
                ...
                messageBridge.message(linker, "linksigns-signFound", location.getBlockX(), location.getBlockY(),
                        location.getBlockZ());
