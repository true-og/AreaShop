...
public class CancellableRegionEvent<T> extends RegionEvent<T> {
     ...
     * 
     * @param reason The reason of cancelling, used for display to the user, should
     *               end with a dot
     */
    ...
    /**
     * Let the event continue, possible overwriting a cancel() call from another
     * plugin.
     */
    public void allow() {
     ...
     * 
     * @return null if there is no reason or the event is not cancelled, otherwise a
     *         string
     */
