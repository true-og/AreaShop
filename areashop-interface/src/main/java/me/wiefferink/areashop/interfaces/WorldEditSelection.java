...
public class WorldEditSelection {
    ...
    public WorldEditSelection(World world, Location a, Location b) {
        ...
        this.world = world;
        this.minimum = new Location(world, Math.min(a.getX(), b.getX()), Math.min(a.getY(), b.getY()),
                Math.min(a.getZ(), b.getZ()));
        this.maximum = new Location(world, Math.max(a.getX(), b.getX()), Math.max(a.getY(), b.getY()),
